...
let s:white       = { "gui": "#f8f8f3", "cterm": "252" }
let s:black       = { "gui": "#000000", "cterm": "234" }
let s:lightblack  = { "gui": "#1D1E17", "cterm": "235" }
...
let s:warmgrey    = { "gui": "#95917E", "cterm": "59" }

let s:pink        = { "gui": "#Ff2a77", "cterm": "197" }
let s:green       = { "gui": "#b6f23D", "cterm": "148" }
let s:aqua        = { "gui": "#66d9ef", "cterm": "81" }
let s:yellow      = { "gui": "#f6eB84", "cterm": "186" }
let s:orange      = { "gui": "#FD9720", "cterm": "208" }
let s:purple      = { "gui": "#be91ff", "cterm": "141" }
...
let s:parencol    = { "gui": "#078a93", "cterm": "81" }

let s:activestatusfg = { "gui": "#ffffff", "cterm": "15" }
let s:activestatusbg = { "gui": "#116b4a", "cterm": "32" }
let s:inactivestatusfg = { "gui": "#e4e4e4", "cterm": "254" }
let s:inactivestatusbg = { "gui": "#2f5757", "cterm": "66" }
...
call s:h("StatusLine",    { "fg": s:activestatusbg,   "bg": s:activestatusfg,        "format": "reverse" })
call s:h("StatusLineNC",  { "fg": s:inactivestatusbg,   "bg": s:inactivestatusfg,     "format": "reverse" })
call s:h("TabLine",       { "fg": s:white,      "bg": s:darkblack,    "format": "reverse" })
call s:h("Visual",        {                     "bg": s:lightgrey })
call s:h("Search",        { "fg": s:black,      "bg": s:green })
call s:h("MatchParen",    { "fg": s:white,      "bg": s:parencol })
call s:h("Question",      { "fg": s:yellow })
call s:h("ModeMsg",       { "fg": s:white,      "format": "bold" })
...
" call s:h("NeomakeErrorSign",        { "bg": s:black, "fg": s:red, "format": "bold" })
call s:h("NeomakeWarningSign",      { "bg": s:lightblack, "fg": s:orange, "format": "bold" })
call s:h("NeomakeMessageSign",      { "bg": s:lightblack, "fg": s:aqua, "format": "bold" })
call s:h("NeomakeInfoSign",         { "bg": s:lightblack, "fg": s:white, "format": "bold" })
